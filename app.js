...
io.on('connection', (socket) => {
  ...
  // Store the room that the socket is connected to If you need to scale the app horizontally, you'll need to store this variable in a persistent store such as Redis.
